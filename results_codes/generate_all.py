...
def main():
    print("="*60)
    print("  Master Script: Running Full Experimentation Suite")
    print("="*60)
    ...
    plot_fig11()
    plot_fig12()
    print("All 12 figures generated successfully inside results_codes/figures/.")
